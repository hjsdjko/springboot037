...
public class RenwutijiaoController {
    ...
    public R page(@RequestParam Map<String, Object> params,RenwutijiaoEntity renwutijiao,
		...
		if(tableName.equals("jiaoshi")) {
			renwutijiao.setJiaoshizhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yonghu")) {
			renwutijiao.setYonghuzhanghao((String)request.getSession().getAttribute("username"));
		}
