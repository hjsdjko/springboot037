...
public class DiscusswenzhangxinxiController {
    ...
    public R security(@RequestParam String username){
        DiscusswenzhangxinxiEntity discusswenzhangxinxi = discusswenzhangxinxiService.selectOne(new EntityWrapper<DiscusswenzhangxinxiEntity>().eq("", username));
        return R.ok().put("data", discusswenzhangxinxi);
    }
    ...
    public R autoSort(@RequestParam Map<String, Object> params,DiscusswenzhangxinxiEntity discusswenzhangxinxi, HttpServletRequest request,String pre){
        EntityWrapper<DiscusswenzhangxinxiEntity> ew = new EntityWrapper<DiscusswenzhangxinxiEntity>();
